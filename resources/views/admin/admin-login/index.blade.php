    ...
    <div class="flex items-center justify-center p-6 sm:p-12">
        <div class="w-full max-w-sm">
            ...
            <form wire:submit="login" class="mt-8 space-y-4">
                <div>
                    <label for="login-email" class="block text-xs font-semibold mb-1.5">Email</label>
                    <input id="login-email" type="email" wire:model="email" autocomplete="email" required class="w-full px-3 py-2.5 text-sm rounded-md bg-background border border-border focus:outline-none focus:ring-2 focus:ring-primary/30" />
                </div>
                <div>
                    <label for="login-password" class="block text-xs font-semibold mb-1.5">Password</label>
                    <input id="login-password" type="password" wire:model="password" autocomplete="current-password" required class="w-full px-3 py-2.5 text-sm rounded-md bg-background border border-border focus:outline-none focus:ring-2 focus:ring-primary/30" />
                </div>
